...
ggplot(model_data_q2, aes(x = avg_block_accuracy, 
  ...
  ggtitle("Predicting future performance from previous performance", "Fitting simple binomials on raw participant data, by switch type")
...
tidy_results <- tidy(fit.mixed_simple_15_final, effects = "fixed", conf.int = TRUE)
