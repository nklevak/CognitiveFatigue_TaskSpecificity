---
title: "pilotC_analysis_prolificSmallSample"
output: html_document
date: "2024-07-03"
---
This is the updated analysis on the pilot D participants (first 15 prolific ones). 
...
In comparison to pilot C, the contrast was reduced for the visual search (making it more difficult), and the VS response time window was smaller as well. 
...
Here, we will exclude participants. We want to exclude participants who never switched. We also want to exclude participants who got over **92% accuracy** on **both** tasks. 
