...
# Get the simple pairwise comparisons within each accuracy category
...
# For the interaction contrasts, we need to test whether the switch-stay difference
# differs between accuracy categories
# First, create an object that represents the switch-stay difference at each accuracy level
