...
// creates practice stim arrays -> for me, it makes sense to focus on conjunction and high load (24)
function createPracticeStimArrays(blockLen) {
  ...
  // creates real stim arrays -> for me, it makes sense to focus on conjunction and high load (24)
...
var practiceCount = 0;
var practiceThresh = 3;//what is this
...
// GOT RID OF ATTENTION CHECK BLOCKS
...
// I might be able to get rid of this, if I just want them to go through the practice trials and then move on
var practiceNode = {
...
var testTrials = [];
// testTrials.push(attentionNode);//got rid of attention checks
for (let i = 0; i < numTrialsPerBlock; i++) {
  testTrials.push(fixationBlock, testTrial, ITIBlock);
}

// maybe i can make the test code for practice to -- ADAPT this one
var testCount = 0;
var testNode = {
...
var {blockStimConditions, blockStimNums, blockStimTargets} = createPracticeStimArrays(practiceLen);
blockStims = getStims(
  blockStimNums,
  blockStimTargets,
  blockStimConditions,
