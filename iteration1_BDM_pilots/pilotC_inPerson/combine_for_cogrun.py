...
if __name__ == "__main__":
    ...
    files = ['./js/init-jspsych.js','./js/instructions.js','./js/spatial-recall.js','./js/visual-search-blocks.js','experiment.html']  # Add your filenames here
    output_file = './cognition_run_files/combined_scripts_final.js'
