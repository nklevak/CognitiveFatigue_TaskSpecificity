...
var preload_with_consent = {
  ...
  show_progress_bar: true,
  max_load_time: 30000,
  images: ['./js/poldrack_consent_form.html','./img/circle.png','./img/square.png']
};
...
var overall_debrief = {
  ...
  stimulus: 
    `<div class="instructions-container">
      ...
      <strong>${getPropRestUsed(bonus_minimum, dependent_bonus)}</strong> dollars. The experiment is over now, press any button to continue to be redirected.</p>
    </div>`,
  on_finish: function(data) {
    data.final_bonus = getPropRestUsed(bonus_minimum, dependent_bonus)
  }
}
